...
public class EntertainmentActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = new Intent(EntertainmentActivity.this, PublicActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_gallery) {
            Intent intent = new Intent(EntertainmentActivity.this, ShopActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_slideshow) {
            Intent intent = new Intent(EntertainmentActivity.this, CorporateFirmActivity.class);
            startActivity(intent);
