...
public class ShopActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = new Intent(ShopActivity.this, PublicActivity.class);
            ...
            Intent intent = new Intent(ShopActivity.this, CorporateFirmActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_manage) {
            Intent intent = new Intent(ShopActivity.this, EntertainmentActivity.class);
            startActivity(intent);
